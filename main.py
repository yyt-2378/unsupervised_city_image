...
def main():
    ...
    # Data loading code
    traindir = 'D:\\project\\unsupervised_image_learning\\lemniscate.pytorch\\train.txt'
    valdir = 'D:\\project\\unsupervised_image_learning\\lemniscate.pytorch\\val.txt'
    ...
    train_dataset = CustomDataset(traindir, train_img_transform)
    ...
    val_loader = torch.utils.data.DataLoader(
        CustomDataset(valdir, val_img_transform),
    ...
    if args.evaluate:
        kNN(0, model, lemniscate, train_loader, val_loader, 1, args.nce_t)
        return
...
if __name__ == '__main__':
    # todo: python main.py DATAPATH --arch resnet18 -j 32 --nce-k 4096 --nce-t 0.07  --lr 0.03 --nce-m 0.5 --low-dim 128 -b 256
    ...
    parser.add_argument('data', metavar='DIR',
                        default='D:\\project\\unsupervised_image_learning\\lemniscate.pytorch\\Data',
    ...
    args = parser.parse_args(["D:\\project\\unsupervised_image_learning\\lemniscate.pytorch\\Data"])
